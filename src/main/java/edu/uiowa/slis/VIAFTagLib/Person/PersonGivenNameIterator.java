...
public class PersonGivenNameIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static PersonGivenNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonGivenNameIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://schema.org/givenName> ?s } ");
			if(rs.hasNext()) {
