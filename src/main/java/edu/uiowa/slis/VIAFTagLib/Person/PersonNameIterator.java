...
public class PersonNameIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static PersonNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonNameIterator.class);
