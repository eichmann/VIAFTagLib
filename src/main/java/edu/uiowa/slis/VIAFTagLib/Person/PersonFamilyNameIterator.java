...
public class PersonFamilyNameIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s where { <" + subjectURI + "> <http://schema.org/familyName> ?s } ");
			if(rs.hasNext()) {
