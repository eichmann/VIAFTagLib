...
public class PersonAlternateNameIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static PersonAlternateNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PersonAlternateNameIterator.class);
