...
public class CreativeWorkWorkExampleIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static CreativeWorkWorkExampleIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CreativeWorkWorkExampleIterator.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			rs = getResultSet(prefix+"SELECT ?s ?t where {"
					+" <" + subjectURI + "> <http://schema.org/workExample> ?s . "
...
//					continue;
			...
			log.error("Exception raised in CreativeWorkWorkExampleIterator doStartTag", e);
			clearServiceState();
			freeConnection();
			throw new JspTagException("Exception raised in CreativeWorkWorkExampleIterator doStartTag");
		}
...
//					continue;
	...
	public  void setWorkExample(String theWorkExample) {
		workExample = theWorkExample;
	}
