...
public class CreativeWorkExampleOfWorkType extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static CreativeWorkExampleOfWorkType currentInstance = null;
	private static final Log log = LogFactory.getLog(CreativeWorkExampleOfWorkType.class);
	...
	public int doStartTag() throws JspException {
		try {
			...
			pageContext.getOut().print(theCreativeWorkExampleOfWorkIterator.getType());
		} catch (Exception e) {
