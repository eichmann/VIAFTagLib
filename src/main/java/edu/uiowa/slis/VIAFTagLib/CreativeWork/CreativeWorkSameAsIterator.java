...
public class CreativeWorkSameAsIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static CreativeWorkSameAsIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(CreativeWorkSameAsIterator.class);
