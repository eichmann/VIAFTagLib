...
public class PlaceNameIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static PlaceNameIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PlaceNameIterator.class);
