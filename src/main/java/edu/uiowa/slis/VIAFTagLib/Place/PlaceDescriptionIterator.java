...
public class PlaceDescriptionIterator extends edu.uiowa.slis.VIAFTagLib.TagLibSupport {
	static PlaceDescriptionIterator currentInstance = null;
	private static final Log log = LogFactory.getLog(PlaceDescriptionIterator.class);
